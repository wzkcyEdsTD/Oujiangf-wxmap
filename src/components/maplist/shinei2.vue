...
<template>
  <div class="main" style="width:100%;height:100%;">
    ...
    <tianditu @mapload="mapload"
              ...
              searchurl="https://services.wzmap.gov.cn/server/rest/services/TESEDT/SNDT_POI/MapServer/0"
  ...
  export default {
    ...
    methods: {
      ...
      mapload(map,view){
        ...
        //室内地图
        this.$refs.map.shinei2(map,view);
      },
      //清除
      qingchu(state){
        if(this.draw){
      ...
      loucengChange(i,idx){
        this.shinei.idx = idx;
        this.$refs.map.louceng2(i.url1,i.url2,i.name);
      },
      //商铺点击
      shineiClick(graphic){
        console.log(graphic);
