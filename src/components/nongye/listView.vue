...
<template>
  ...
  <div id="jiaoyuListView">
    ...
    <div class="clear h20"></div>
    <!-- 推荐线路 -->
    <div class="rt_tit mart" v-if="tourline && tourline.length" style="margin:0 10px;margin-bottom:10px;width:auto;box-sizing: border-box;">
      <strong>旅游线路</strong>
    </div>
    <!--  -->
      ...
      async queryZhoubian(){
        ...
        esriLoader.loadModules([
          ...
          'esri/geometry/Point'
            ...
            query.where = " TAG LIKE '%"+self.tag1+"%' AND NAME IS NOT NULL AND "+prefix+"NAME!='"+(self.content.name || self.content.NAME)+"' AND FEATUREGUID!='"+self.content.featureguid+"'";
