...
<template>
  <div id="nongye">
    ...
    <div class="ly_top_map">
      <img src="@/img/ly_top_map.jpg" @click="$router.push({name:'daolan'})" class="ims" alt=""/>
    </div>
    <!--banner-->
    <div class="main">
      ...
      <div class="ly_ctit">
        <img src="@/img/ly1.png" alt="" style="width:50%" />
      </div>
